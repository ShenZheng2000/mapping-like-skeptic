...
def get_data(pred_matching_result_raw, gts, origin, roi_size, num_interp, result_path, denorm=False):
    ### collect data, interpolate without multiprocessing
    token_list = []
    ...
    # Process data sequentially instead of using multiprocessing
    data_infos = [fn(*args) for args in token_list]
    ...
    for data_info in data_infos:
        ...
        num_gts += num_gts_single
        num_preds += num_preds_single
