...
# # nuScenes (predictions, vis_global) - w_centerline
# python tools/visualization/vis_global.py \
...
#     --out_dir vis_global/nuscenes_geosplit/skeptic_w_centerline \
#     --option vis-pred \
#     --per_frame_result 1

# # # nuScenes (GT, vis_global) - w_centerline
# python tools/visualization/vis_global.py \
#     plugin/configs/skeptic/nuscenes_newsplit/mls_nusc_new_3_joint_finetune_w_centerline.py \
#     --data_path datasets/nuscenes/nuscenes_map_infos_val_gt_tracks.pkl \
#     --out_dir vis_global/nuscenes_geosplit/gt_w_centerline \
#     --option vis-gt \
#     --per_frame_result 1
