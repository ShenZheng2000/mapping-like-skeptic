...
train_pipeline = [
    ...
    dict(type='ExtractBEV2Perspective', roi_size=roi_size, bev_array_size=(bev_h, bev_w), 
         perspective_grids=perspective_grids, height_levels=height_levels, allow_spatial_overlap=True, dataset="argoverse"),
...
test_pipeline = [
    dict(type='LoadMultiViewImagesFromFiles', to_float32=True),
    dict(type='ExtractBEV2Perspective', roi_size=roi_size, bev_array_size=(bev_h, bev_w),
         perspective_grids=perspective_grids, height_levels=height_levels, allow_spatial_overlap=True, dataset="argoverse", precision=0.15),
    dict(type='ResizeMultiViewImages',
         size=img_size,  # H, W
         change_intrinsics=True,
         ),
...
load_from = "./work_dirs/mls_av2_new_100x50_1_bev_pretrain/latest.pth"
