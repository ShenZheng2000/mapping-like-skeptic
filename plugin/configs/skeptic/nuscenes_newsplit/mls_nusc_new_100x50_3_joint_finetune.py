...
perspective_grids = (100, 60)  # x, y

# precision for faster loading
precision = (-1, 0.15) # train-test precision
...
train_pipeline = [
    ...
    dict(type='ExtractBEV2Perspective', roi_size=roi_size, bev_array_size=(bev_h, bev_w),
         perspective_grids=perspective_grids, height_levels=height_levels, allow_spatial_overlap=True, dataset="nuscenes", precision=precision[0]),
...
test_pipeline = [
    dict(type='LoadMultiViewImagesFromFiles', to_float32=True),
    dict(type='ExtractBEV2Perspective', roi_size=roi_size, bev_array_size=(bev_h, bev_w),
         perspective_grids=perspective_grids, height_levels=height_levels, allow_spatial_overlap=True, dataset="nuscenes", precision=precision[1]),
    dict(type='ResizeMultiViewImages',
         size=img_size,  # H, W
         change_intrinsics=True,
         ),
...
load_from = "./work_dirs/mls_nusc_new_100x50_2_warmup/latest.pth"
