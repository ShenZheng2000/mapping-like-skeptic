...
train_pipeline = [
    ...
    dict(type='ExtractBEV2Perspective', roi_size=roi_size, bev_array_size=(bev_h, bev_w),
         perspective_grids=perspective_grids, height_levels=height_levels, allow_spatial_overlap=True, dataset="nuscenes", precision=-1),
...
load_from = "./work_dirs/mls_nusc_new_100x50_1_bev_pretrain/latest.pth"
